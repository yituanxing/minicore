...
private[v2] object TinyRobGeometry {
  // P8 experiment geometry. Keep this centralized so ROB storage, lifetime
  // identities, dependency state and scheduling projections widen together.
  val Entries: Int = 8
  val IndexBits: Int = 3
...
class TinyRob(val xlen: Int) extends Module {
  ...
  // indexing wraps naturally in the power-of-two slot domain; age<count is
